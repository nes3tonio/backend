...
const recuperarPass = async (req, res, next) => {
    ...
    try {
        ...
        const emailBody = `
            Se solicitó un cambio de contraseña para el usuario registrado con este email en la web de nuestro proyecto.
        ...
        await sendMail({
            to: email,
            subject: 'Cambio de contraseña en nuestro proyecto',
            body: emailBody,
        });
