...
const newEspacio = async (req, res, next) => {
    ...
    try {
        ...
        const { descripcion, precio, capacidad, direccion, cif, razonsocial, contacto, idUsuario } = req.body;
        ...
        const [nuevoEspacio] = await connection.query(
            `
                ...
                VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?)
            `,
            [descripcion, precio, capacidad, direccion, cif, razonsocial, contacto, idUsuario, createdAt]
        );
